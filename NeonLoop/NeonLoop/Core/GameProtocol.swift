...
enum NeonLoopGameRegistry {
    static let allGames: [GameInfo] = [
        ...
        GameInfo(
            ...
            description: "Work together to defend the center goal in a circular maze from waves of incoming pucks.",
            minPlayers: 2,
            maxPlayers: 6,
            inputType: .position,
            isImplemented: false,
        ...
        GameInfo(
            ...
            description: "CPU shows its shot trajectory. You have 5 seconds to pick your escape vector. Don't get hit!",
            minPlayers: 2,
            maxPlayers: 6,
            inputType: .vector,
            isImplemented: false,

...
struct ContentView: View {
    ...
    var body: some View {
        ...
        Group {
            ...
            case .playingFoosball:
                let _ = print("📱 [ContentView]   → Showing FoosballGameView")
                let _ = print("📱 [ContentView]   → foosballCoordinator at switch: \(coordinator.foosballCoordinator != nil ? "EXISTS" : "NIL")")
                FoosballGameView()
